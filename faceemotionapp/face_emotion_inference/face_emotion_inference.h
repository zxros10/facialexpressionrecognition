...
* @date 2018-5-19
*/
#ifndef face_emotion_inference_ENGINE_H_
#define face_emotion_inference_ENGINE_H_
...
class face_emotion_inference : public hiai::Engine {
public:
...
private:
    ...
    * @return: Whether init success
    */
    bool NormalizeData (std::vector<cv::Mat> &normalized_image);
    ...
    */
    bool ArrangeFaceMarkInfo(
        const std::shared_ptr<hiai::AISimpleTensor> &result_tensor,
