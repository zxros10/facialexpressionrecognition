...
* @date 2018-5-19
*/
#ifndef face_emotion_postprocess_ENGINE_H_
#define face_emotion_postprocess_ENGINE_H_
#include "face_emotion_estimate_params.h"
...
class face_emotion_postprocess : public hiai::Engine {
public:
    face_emotion_postprocess();
    ~face_emotion_postprocess() = default;
    char **id2string;
    void GetEmotionString(float result[],int nLen,char *str);
    ...
    */
    ...
    private : bool IsSupportFormat(hiai::IMAGEFORMAT format);
